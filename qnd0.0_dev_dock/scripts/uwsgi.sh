...
cp -f /qnd0.0_app_dev/qnd00_app_dev/baton.min.js /py/lib/python3.10/site-packages/baton/static/baton/app/dist/
python manage.py migrate --noinput
python manage.py createsuperuser --email $SUPERUSER_EMAIL --noinput || true
python manage.py collectstatic --settings=qnd00_app_dev.settings.local --noinput 
...
uwsgi --http :9000 --workers 9 --master --enable-threads --module qnd00_app_dev.wsgi  --ini uwsgi_stage.ini
